...
const LOGIN = ERROR_TYPES.USER.LOGIN,
      SIGN_UP = ERROR_TYPES.USER.SIGN_UP,
      FORGOT_PASSWORD = ERROR_TYPES.USER.FORGOT_PASSWORD,
      RESET_PASSWORD = ERROR_TYPES.USER.RESET_PASSWORD,
      USER = ERROR_TYPES.USER;
...
const errorHandler = (ERROR_TYPE, res, message) => {
  switch (ERROR_TYPE) {

    case LOGIN.NO_MATCH:
      return res(null, false, { type:'email', error: "Your login details do not match. Please try again." });
    case LOGIN.PASSPORT_ERROR:
      return res.status(422).send(message);
    case LOGIN.NON_EXISTING_EMAIL:
